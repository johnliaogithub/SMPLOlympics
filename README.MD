...
pip install numpy cython wheel "setuptools<58.0.0"   # Install the dependencies chumpy needs to build its wheel

pip install -r requirement.txt
```

2. Install [isaacgym](https://docs.nvidia.com/isaac/isaacgym/doc/setup.html). Since Isaac Gym is deprecated, you will need to install from this site: [New Isaac Gym URL](https://developer.nvidia.com/isaac-gym/download)

```
tar -xvzf [link to .tar.gz file] # unzip Isaac Gym file
cd isaacgym/python
pip install -e .
```
